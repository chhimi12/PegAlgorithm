...
class draw:
    ...
    def __init__(self, path, row, col, rule):
        ...
        self.circles = [[Circle((0, 4), r)],
                        ...
                        [Circle((-4, 0), r), Circle((-2, 0), r), Circle((0, 0), r), Circle((2, 0), r),
                         Circle((4, 0), r)]]
    ...
    def animation(self):
        self.anim = animation.FuncAnimation(self.fig, self.draw, frames=2 * len(self.path), interval=2000, blit=True,
                                            repeat=False)
        # save and show
        self.show()
